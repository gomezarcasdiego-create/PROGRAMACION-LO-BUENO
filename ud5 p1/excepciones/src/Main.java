...
public class Main {
    ...
    public static void ejercicio1 (String[]args) throws FileNotFoundException {
    ...
    public static void ejercicio2 (String[]args) throws FileNotFoundException {
        Scanner sc = new Scanner(System.in);
    ...
    public static void ejercicio3 (String[]args) throws ArithmeticException{
        Scanner sc = new Scanner(System.in);
    ...
    public static void ejercicio4 (String[]args) throws Exception {
    ...
    public static void ejercicio5 (String[]args) throws Exception {
        Scanner sc = new Scanner(System.in);
    ...
    public static void ejercicio6 (String[]args) throws Exception {
        Scanner sc = new Scanner(System.in);
